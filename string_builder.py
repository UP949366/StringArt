...
LINE_WEIGHT = 17  # Tweakable parameter
FILENAME = "ami.jpg"
SCALE = 50  # For making a very high resolution render, to attempt to accurately gauge how thick the thread must be
HOOP_DIAMETER = 0.5  # To calculate total thread length

tic = time.perf_counter()

img = center_crop(cv2.imread(FILENAME, cv2.IMREAD_GRAYSCALE))
